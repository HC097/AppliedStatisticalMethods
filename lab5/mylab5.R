...
B
#All boxes (categories) equally likely in this created sample
sample(B,size=20,prob=c(1/5,1/5,1/5,1/5,1/5),replace=TRUE)

## sampling function that creates a matrix to hold samples which are put into a table and made into a barplot
...
#makes iterations of samples into bar plots
