...
#four plots made according to prompt
chi1<-mychisim(n1=10,iter=1000,mean1=10,sigma1=4,ymax=.15)
chi2<-mychisim(n1=20,iter=1000,mean1=10,sigma1=4)
chi3<-mychisim(n1=100,iter=1000,mean1=10,sigma1=4)
chi4<-mychisim(n1=200,iter=1000,mean1=10,sigma1=4)

#histogram according to prompt
...
```{r}
myTsim<-function(n1=10,sigma1=3,mean1=5,iter=1000,ymax=0.5,...){    # adjust ymax to make graph fit
y1=rnorm(n1*iter,mean=mean1,sd=sigma1)# generate iter samples of size n1
...
#plots according to prompt
T1<-myTsim(n1=10,iter=1000,mean1=10,sigma1=4)
T2<-myTsim(n1=20,iter=1000,mean1=10,sigma1=4)
T3<-myTsim(n1=100,iter=1000,mean1=10,sigma1=4)
T4<-myTsim(n1=200,iter=1000,mean1=10,sigma1=4)
...
#plots according to prompt
chiTwo1<-mychisim2(n1=10,n2=10, mean1=5,mean2=10,sigma1=4,sigma2=4,iter=1000)
chiTwo2<-mychisim2(n1=20,n2=10,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=1000)
chiTwo3<-mychisim2(n1=50,n2=50,mean1=5,mean2=10,sigma1=4,sigma2=4,iter=10000)
chiTwo4<-mychisim2(n1=80,n2=50,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=10000)

#histogram according to prompt
chiTwo5<-mychisim2(iter=10000)
hist(chiTwo5$w)
```
...
```{r}
knitr::include_graphics("Table6pt3a.png")

#The T statistic is equal to the subtraction of two population means (mu) from two sample means (ybar) over the sample standard deviation multiplied by the square root of one over the number of items in the first sample plus one over the number of items in the second sample.

#Here is the code asked for: w=((ybar1-ybar2)-(mean1-mean2))/sqrt(spsq*(1/n1+1/n2)).
...
myTsim2<-function(n1=10,n2=14,sigma1=3,sigma2=3,mean1=5,mean2=10,iter=1000,ymax=0.5,...){
  ...
  legend('topright',c("Simulated","Theoretical"),col=c("Blue","Red"),lwd=4,lty=1:2,bty="n",title=title)# Legend #i'm putting the legend in the topright instead of where I click cuz that would require the locator function which is not to be used in markdown
  return(list(w=w,summary=summary(w),sdw=sd(w),fun="T")) # some output to use if needed
}

#prompted plotting
tStat1<-myTsim2(n1=10,n2=10,mean1=5,mean2=10,sigma1=4,sigma2=4,iter=1000)
tStat2<-myTsim2(n1=20,n2=10,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=1000)
tStat3<-myTsim2(n1=50,n2=50,mean1=5,mean2=10,sigma1=4,sigma2=4,iter=10000)
tStat4<-myTsim2(n1=80,n2=50,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=10000)

#prompted histogram
tStat5<-myTsim2(iter=10000)
hist(tStat5$w)
```
...
#prompted plotting
fStat1<-myFsim2(n1=10,n2=10,mean1=5,mean2=10,sigma1=4,sigma2=4,iter=1000)
fStat2<-myFsim2(n1=20,n2=10,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=1000)
fStat3<-myFsim2(n1=50,n2=50,mean1=5,mean2=10,sigma1=4,sigma2=4,iter=10000,ymax=1.5)
fStat4<-myFsim2(n1=80,n2=50,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=10000,ymax=1.5)

#prompted histogram
fStat5<-myFsim2(iter=10000)
hist(fStat5$w)
```
